questions =  [
    {"id": 0, "question": "Freedom of business is the best practical way a society can prosper.", "effects": {"right": 999}},
    ...
    {"id": 46, "question": "Redistributing wealth away from the wealthy through taxes is a viable way of defeating inequality.", "effects": {"right": -1}},
    {"id": 47, "question": "If economic globalisation is inevitable, it should primarily serve humanity rather than the interests of trans-national corporations.", "effects": {"prog": 1}},
    {"id": 48, "question": "I’d always support my country, whether it was right or wrong. No matter what.", "effects": {"auth": 2}},
    {"id": 49, "question": "No one chooses their country of birth, so it’s foolish to be proud of it.", "effects": {"prog": -0.5}},
    {"id": 50, "question": "Our race has many superior qualities, compared with other races.", "effects": {"prog": -4}},
    {"id": 51, "question": "Military action that defies international law is sometimes justified.", "effects": {"auth": 1}},
    {"id": 52, "question": "Workplace democracy is a fundamentally good idea.", "effects": {"right": -2}},
    {"id": 53, "question": "Protectionism is sometimes necessary in trade.", "effects": {"right": 0.5, "auth": 0.5}},
    {"id": 54, "question": "The only social responsibility of a company should be to deliver a profit to its shareholders.", "effects": {"right": 1}},
    {"id": 55, "question": "The rich are too highly taxed.", "effects": {"prog": 1}}
